...
class InstallPayment extends Migrator
{
    ...
    private function _create_plugin_payment_refund()
    {
        ...
        $this->table($table, [
            ...
            ->addColumn('refund_images', 'string', ['limit' => 999, 'default' => '', 'null' => true, 'comment' => '凭证支付图片'])
            ...
            ->addIndex('order_no', ['name' => 'idx_plugin_payment_refund_order_no'])
            ->addIndex('create_time', ['name' => 'idx_plugin_payment_refund_create_time'])
            ->addIndex('channel_type', ['name' => 'idx_plugin_payment_refund_channel_type'])
            ->addIndex('channel_code', ['name' => 'idx_plugin_payment_refund_channel_code'])
